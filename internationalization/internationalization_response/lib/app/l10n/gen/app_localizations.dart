...
abstract class AppLocalizations {
  ...
  /// No description provided for @taskAmount.
  ///
  /// In en, this message translates to:
  /// **'{amount, plural, =0{Empty} =1{1 task} other{{amount} tasks}}'**
  String taskAmount(num amount);

  /// No description provided for @dailyRoutine.
  ///
  /// In en, this message translates to:
  /// **'{daily, select, m{Morning Routine} a{Afternoon Routine} n{Night Routine} other{Routine}}'**
